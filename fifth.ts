...
//Grid that is placed under the floor to give the impression of a floor
const gridHelper = new THREE.GridHelper(50, 20, 0x0000ff, 0xffffff)//0xaec6cf, 0xaec6cf)
...
//This section adds an animation that make the cube rotate 
// while between 40-60 percent of scroll
animationScripts.push({
    start: 40,
    end: 60,
    func: () => {
